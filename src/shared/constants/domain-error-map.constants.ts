...
export const DOMAIN_ERROR_STATUS_MAP: Record<string, HttpStatusCode> = {
	...
	RESTAURANT_NOT_FOUND: HTTP_STATUS.NOT_FOUND,
	...
	STAFF_INVITATION_ALREADY_PENDING: HTTP_STATUS.CONFLICT,
	...
	INVALID_INVITATION_TOKEN: HTTP_STATUS.BAD_REQUEST,
	INVITATION_EXPIRED: HTTP_STATUS.BAD_REQUEST,
	STAFF_INVITATION_NOT_FOUND: HTTP_STATUS.NOT_FOUND,
