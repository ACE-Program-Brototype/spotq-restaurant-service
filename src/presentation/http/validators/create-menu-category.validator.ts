...
export const createMenuCategoryParamsSchema = z.object({
	restaurantId: z
		.string()
		.uuid({ message: messages.INVALID_RESTAURANT_ID }),
});

export const listMenuCategoriesParamsSchema = z.object({
	restaurantId: z
		.string()
		.uuid({ message: messages.INVALID_RESTAURANT_ID }),
});
...
>;
export type ListMenuCategoriesParams = z.infer<
	typeof listMenuCategoriesParamsSchema
>;
